...
<!-- The agenda will be concise, focusing on the structure of the interview and the time allocated for each part. -->
...
<!-- This section will describe the competencies required for the role, directly linked to the job description and Maxwell Fairview's values. -->
...
<!-- This section will describe a hypothetical scenario that the candidate will work through, demonstrating their practical skills and alignment with Maxwell Fairview's values. -->
